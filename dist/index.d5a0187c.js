...
})({"j2fTq":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9ee11785d5a0187c";
...
},{}],"7SrOl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _app = require("./App");
var _appDefault = parcelHelpers.interopDefault(_app);
new _appDefault.default();

},{"./App":"lOX6Y","@parcel/transformer-js/src/esmodule-helpers.js":"akIfY"}],"lOX6Y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        ...
        if (this.state === "searching") {
            if (this.target !== null) {
                ...
                if (targetBox.x === this.x && targetBox.y === this.y) {
                    ...
                    if (this.count > this.simulation.rows * this.simulation.columns / 2) this.state = "failed";
                    this.randomNumbers.splice(this.randomNumbers.indexOf(this.target), 1);
                    if (this.simulation.mode === "loop") this.target = targetBox.contains;
                    else this.target = this.randomNumbers[0];
                }
...
class Simulation {
    ...
    addPrisoner() {
        if (this.prisoners.length < this.boxes.length) this.prisoners.push(new Prisoner(this.prisoners.length, this));
    }
    main() {
        this.tick();
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"akIfY"}],"akIfY":[function(require,module,exports) {
...
//# sourceMappingURL=index.d5a0187c.js.map
